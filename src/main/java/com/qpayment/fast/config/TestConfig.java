...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Charge ch1 = new Charge(null, "Pagamento Renan", 120.0, Instant.now(), "localhost:8080/link1", ChargeStatus.PAID, c2);
		Charge ch2 = new Charge(null, "Pagamento Joana", 150.0, Instant.now(), "localhost:8080/link2", ChargeStatus.WAITING_PAYMENT , c1);
